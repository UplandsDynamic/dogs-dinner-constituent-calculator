...
with st.expander(':green[Click to expand details about what this app does, and why it does it.]'):
    st.markdown(
        "The purpose of this calculator is to provide 'Dry Matter Basis' comparison between commercially available dog foods, where the 'analytical constituents' are provided by the manufacturer 'As Fed'.\n\nConverting the 'As Fed' constituent measures to a 'Dry Matter Basis' basis allows for a more accurate comparison between wet and dry foods.\n\nFor more details about what 'Dry Matter Basis' is, why it matters, and how it is calculated, see [this page on the All About Dog Food website](https://www.allaboutdogfood.co.uk/dog-food-terms/0013/dry-matter-nutrients).\n\nSpecifically, this calculator assesses the suitability of the food constituents for dogs with kidney disease ('renal diet'), and for dogs with disease of the pancreas ('pancreatitis diet').\n\nDefault values for the calculations used to establish the suitability of the dog food constituents are based mainly on the information provided by the [All About Dog Food](https://allaboutdogfood.co.uk) and [PetMD](https://www.petmd.com/dog/nutrition/what-feed-dog-kidney-disease) websites.")
